...
export class FileService {
     ...
     * @param reportProgress flag to report request and response progress.
     */
    public apiFilesPathGet(path: string, observe?: 'body', reportProgress?: boolean): Observable<any>;
    public apiFilesPathGet(path: string, observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
    public apiFilesPathGet(path: string, observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
    public apiFilesPathGet(path: string, observe: any = 'body', reportProgress: boolean = false ): Observable<any> {

        if (path === null || path === undefined) {
            throw new Error('Required parameter path was null or undefined when calling apiFilesPathGet.');
        }
